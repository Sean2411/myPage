...
app.constant('JS_REQUIRES', {
    ...
    scripts: {
        ...
        'overviewCtrl': ['assets/js/controllers/overviewCtrl.js'],
        'uploadCtrlLL': ['assets/js/controllers/uploadLLtour.js'],
        'loginCtrl': ['assets/js/controllers/loginCtrl.js'],
        'moduleCtrl': ['assets/js/controllers/moduleCtrl.js'],
        // 'modules': ['assets/js/controllers/modules.js'],
